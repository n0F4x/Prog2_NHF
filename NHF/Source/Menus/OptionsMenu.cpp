...
OptionsMenu::OptionsMenu() {
	...
	auto* backButton = new Button{ "Back", AppData::assets.getFont("Dameron"), 76u, [this]() {Menu::close(); } };
	...
	auto* title = new Text{ "OPTIONS", AppData::assets.getFont("The Wireframe"), 132u };
	...
	auto* LCbar = new Bar<int>{
		Window::getSize().x * 0.6f, { 3, 4, 5, 6, 7, 8 }, { "3", "4", "5", "6", "7", "8" }, AppData::assets.getFont("Dameron"), 56u,
	...
	auto* LClabel = new Text{ "Lane Count:", AppData::assets.getFont("Dameron"), 56u };
	...
	auto* JKlabel = new Text{ "Jump Key:", AppData::assets.getFont("Dameron"), 56u };
	...
	auto* PCbar = new Bar<PlatformControl>{
		Window::getSize().x * 0.6f, { PlatformControl::Keyboard, PlatformControl::Mouse }, { "Keyboard", "Mouse" }, AppData::assets.getFont("Dameron"), 56u,
	...
	auto* PClabel = new Text{ "Control Mode:", AppData::assets.getFont("Dameron"), 56u };
	...
	auto* SK1label = new Text{ "Switch Key 1:", AppData::assets.getFont("Dameron"), 56u };
	...
	auto* SK2label = new Text{ "Switch Key 2:", AppData::assets.getFont("Dameron"), 56u };
