	...
	Menu{ appData }
{
	...
	Button* playButton = new Button{ "Play", _appData.assets.getFont("Dameron"), 56u, [&]() { _appData.menus.open("Game"); } };
	...
	Button* optionsButton = new Button{ "Options", _appData.assets.getFont("Dameron"), 56u, [&]() { _appData.menus.open("Options"); } };
